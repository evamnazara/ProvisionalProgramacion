...
Una vez confeccionado el grafo, la complejidad ciclomática (V(G)) se puede calcular se 3
formas:
...
nodos para que comience en cero, y en la que cada fila representa un nodo y contiene los
números de los nodos a los que apunta. Por ejemplo, los grafos de la figura anterior se
podrían codificar así:*/
