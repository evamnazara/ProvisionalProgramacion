...
public class e1301_Saludar {
    /*
     * E1301. Definir una interfaz funcional cuya función abstracta permita generar
     * un saludo
     * dirigido al objeto que se le pasa como parámetro. Implementar un saludo para
     * nombres
     * (clase String) y otro para clientes (clase Cliente). Aplicarlas a varios
     * casos particulares.
     */

    public static interface Saludo<T> {
    ...
    public class Main {
        ...
        /*
         * E1303.
         * Implementar un método estático (max) al que se pasa como parámetro una tabla
         * de tipo genérico y un comparador para dicho tipo. El método devuelve el valor
         * máximo de los elementos de la tabla según el criterio de orden del
         * comparador. Aplicarlo a una tabla de clientes para buscar el de más edad.
         */
        // METODO E1303
