...
public class Meiga implements Comparable<Meiga> {
    ...
    public int lanzarFeitizos() {
        // ordenar primero los hechizos por mas dificultade
        ...
        for (Feitizo feitizo : feitizos) {
            // comprobar si se puede lanzar el hechizo
    ...
    public int compareTo(Meiga o) {
        return alcume.compareTo(o.alcume); // orden alfabetico
    }
    ...
    public String toString() {
        ...
        // feitizos ordenados por orden DECRECIENTE (2-1) y si empate, alfabeico
        Comparator<Feitizo> compFeitizoDificultade = (f1, f2) -> f2.getDificultade() - f1.getDificultade();
        ...
        // inventario en orden alfabetico
        // como es un mapa, tenemos que coger el String, que es la clave
        // se pasa en el contructor, al ser treeset ya se ordena
