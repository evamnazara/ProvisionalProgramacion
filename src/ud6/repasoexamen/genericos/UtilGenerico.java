...
public class UtilGenerico {
    //(1) Método genérico repetidos() que reciba una lista de elementos y devuelva una copia de la lista original pero eliminando los elementos que aparecen sólo una vez.
    ...
    //Método genérico filtrarMayores() que recibe como parámetros de entrada unha colección de elementos de un tipo T, un elemento del mismo tipo y un comparator y devuelve una subcolección con los elementos de la colección original que sean mayores o iguales que el recibido según el criterio del comparator. Crea un pequeño programa principal en la propia clase UtilGenerico que muestre ejemplos de uso de los métodos creados.
