...
public class Sorteo<T> {
    ...
    Set<T> premiados(int numPremiados) {
        ...
        List<T> lista = new ArrayList<>(elementos); //instanciar ya con todos los elementos
    ...
    public static void main(String[] args) {
        ...
        sorteo.add(new Personaje("Mara", Raza.ELFO, 100, 100, 100, 7, 15000));
